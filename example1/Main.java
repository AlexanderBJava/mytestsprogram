...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       //массив !!!!ДЛЯ!!!! целых кошек
        ...
        cats[0]=new Cat(); //ОБЪЕКТ иил ЭКЗЕМПЛЯР КЛАССА Cat (кошка номер НОЛЬ. из загона Cat[SIZE])
        ...
        System.out.println(cats[1].weight); // Вес до операции кормления
        System.out.println(feedCat(cats[1]));//передаем АДРЕС В ПАМЯТИ где хранится кошка, НО НЕ КОШКУ.
        System.out.println(cats[1].weight); // вес после выполнения feedCat(cats[1])
